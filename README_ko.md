...
| [NvMultiObjectTracker의 고급 구성](deep_learning/inference/deepstream_nvmultiobjecttracker_part3.md)                         | 이 기사에서는 특정 사용 사례에 대해 추적기를 최적화하는 방법에 중점을 두고 NvMultiObjectTracker의 고급 구성 매개변수에 대해 논의합니다.                             | DeepStream, NvMultiObjectTracker, Configuration |
