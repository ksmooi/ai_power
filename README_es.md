...
| [Generación de Conjuntos de Datos con Unstructured.io y GPT4](deep_learning/dataset/generate_dataset_with_unstructureio_gpt4.md) | Este artículo demuestra cómo usar Unstructured.io y GPT-4 para procesar archivos PDF y generar conjuntos de datos extrayendo y organizando contenido. | Unstructured.io, GPT-4 |
| [Generación de Conjuntos de Datos con Table Transformer y GPT4](deep_learning/dataset/generate_dataset_with_table_transformer.md) | Este artículo explica cómo usar Table Transformer y GPT-4 para generar conjuntos de datos a partir de archivos PDF detectando y extrayendo estructuras de tablas. | Table Transformer, GPT-4 |
...
| [Understanding DPO and ORPO](deep_learning/training/rlhf_dpo_orpo_overview.md) | Este artículo explora la Optimización de Preferencias Directas (DPO) y la Optimización de Preferencias por Cociente de Probabilidades (ORPO), detallando sus metodologías, funciones de pérdida y aplicaciones prácticas en el ajuste fino de modelos de lenguaje para alinearlos con las preferencias humanas. | RLHF, DPO, ORPO |
...
| [Configuración avanzada de NvMultiObjectTracker](deep_learning/inference/deepstream_nvmultiobjecttracker_part3.md)          | Este artículo discute los parámetros avanzados de configuración de NvMultiObjectTracker, enfocándose en cómo optimizar el rastreador para casos de uso específicos. | DeepStream, NvMultiObjectTracker, Configuration |
